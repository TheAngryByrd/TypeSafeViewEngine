...
[<assembly: AssemblyTitleAttribute("TypeSafeViewEngine.Tests")>]
[<assembly: AssemblyProductAttribute("TypeSafeViewEngine")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "TypeSafeViewEngine.Tests"
    let [<Literal>] AssemblyProduct = "TypeSafeViewEngine"
